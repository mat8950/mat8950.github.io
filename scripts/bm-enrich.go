...
var META = map[string][2]string{
	...
	// Batch juin 2026
	"https://coroot.com":                                                 {"Plateforme APM open-source avec analyse de cause racine IA, métriques, logs, traces et profiling continu unifiés.", "apm|observability|monitoring|ebpf|ai|open-source"},
	"https://goaccess.io":                                                {"Analyseur de logs web en temps réel avec interface TUI interactive ou rapport HTML sans dépendance externe.", "logs|web-analytics|tui|nginx|apache|monitoring|cli"},
	"https://codeburn.app/":                                              {"Dashboard TUI de suivi des coûts et de la consommation de tokens pour Claude Code, Codex et Cursor.", "claude-code|tokens|cost|observability|tui|cursor"},
	"https://reactbits.dev":                                              {"Collection open-source de composants React animés et interactifs pour créer des sites web mémorables.", "react|components|animations|ui|open-source"},
	"https://github.com/margelo/react-native-graph":                      {"Bibliothèque React Native de graphes et courbes hautes performances construite avec Skia.", "react-native|charts|graphs|skia|mobile|performance"},
	"https://github.com/leeoniya/uPlot":                                  {"Bibliothèque JavaScript légère et ultra-rapide pour les séries temporelles, lignes, aires et données OHLC.", "charts|time-series|javascript|performance|lightweight"},
	"https://payloadcms.com":                                             {"CMS headless open-source fullstack Next.js avec backend TypeScript et panel admin généré instantanément.", "cms|headless|nextjs|typescript|self-hosted|open-source"},
	"https://gitcomet.dev":                                               {"Client Git open-source ultra-rapide avec interface moderne construit en Rust et GPUI.", "git|client|gui|rust|gpui|open-source"},
	"https://alibaba.github.io/open-code-review/":                        {"Outil de revue de code hybride testé à l'échelle Alibaba : pipeline déterministe et agent LLM avec commentaires ligne par ligne.", "code-review|ai|llm|ci-cd|java|security"},
	"https://deptry.com/":                                                {"Détecteur de dépendances Python inutilisées, manquantes ou transitives pour maintenir des projets propres.", "python|dependencies|linting|cicd|rust"},
	"https://cilium.io":                                                  {"Networking, sécurité et observabilité eBPF pour Kubernetes avec enforcement de politiques au niveau noyau Linux.", "ebpf|kubernetes|networking|security|cni|observability"},
	"https://alvr.dev":                                                   {"Image Docker Alpine légère et préconfigurée pour compiler et tester des applications Android en CI/CD.", "docker|android|alpine|ci-cd|mobile|build"},
	"https://radarhq.io":                                                 {"Interface Kubernetes open-source avec topologie, timeline d'événements, trafic de services et gestion Helm.", "kubernetes|ui|dashboard|helm|topology|monitoring"},
	"https://enetx.surf":                                                 {"Client HTTP Go avancé avec émulation de navigateur Chrome/Firefox, fingerprinting JA3/JA4 et contournement anti-bot.", "go|http|browser-emulation|tls|web-scraping|anti-bot"},
	"https://rmux.io":                                                    {"Multiplexeur universel Rust avec SDK typé pour piloter n'importe quelle application CLI ou TUI depuis du code.", "rust|multiplexer|cli|tui|automation|sdk"},
	"https://github.com/sharkdp/hexyl":                                   {"Visionneur hexadécimal en ligne de commande avec coloration syntaxique par type de données binaires.", "hex|cli|rust|terminal|binary|developer-tools"},
	"https://github.com/homeport/termshot":                               {"Capture des sorties de commandes terminal en images propres avec fond et padding personnalisables.", "terminal|screenshot|cli|go|developer-tools"},
	"https://gh-dash.dev":                                                {"Interface TUI riche pour GitHub pour gérer pull requests, issues et reviews sans quitter le terminal.", "github|tui|cli|go|productivity|developer-tools"},
	"https://palash.dev/omnivoice":                                       {"Application desktop de clonage vocal local open-source, alternative à ElevenLabs supportant 646 langues.", "voice-cloning|tts|local-ai|self-hosted|elevenlabs|speech"},
	"https://github.com/gurjar1/OmniDictate":                             {"Dictée vocale locale et gratuite pour Windows via faster-whisper, sans cloud ni abonnement.", "speech-to-text|windows|whisper|dictation|local-ai|privacy"},
	"https://www.paddleocr.com":                                          {"Toolkit OCR léger supportant 100+ langues pour transformer PDFs et images en données structurées pour les LLMs.", "ocr|pdf|rag|multimodal|python|baidu"},
	"https://sadtalker.github.io/":                                       {"Génération réaliste de visages parlants animés à partir d'une image fixe et d'un audio (CVPR 2023).", "talking-face|deepfake|animation|ai|research|audio"},
	"https://scira.ai":                                                   {"Moteur de recherche IA minimaliste avec citations, alternative open-source à Perplexity basée sur Vercel AI SDK.", "search|ai|perplexity|open-source|citations|vercel"},
	"https://github.com/microsoft/TRELLIS.2":                             {"Modèle Microsoft de génération 3D native depuis des représentations latentes structurées et compactes.", "3d-generation|ai|microsoft|research|latent-space"},
	"https://yihua7.github.io/AniGen_web/":                               {"Génération d'assets 3D animés avec rigging et skinning automatiques présentés à SIGGRAPH 2026.", "3d|animation|rigging|ai|siggraph|research"},
	"https://pypi.org/project/turbovec/":                                 {"Index vectoriel hautes performances basé sur TurboQuant écrit en Rust avec bindings Python pour la recherche RAG.", "vector-search|rust|python|rag|embeddings|performance"},
	"https://mealpy.readthedocs.io":                                      {"Collection Python des algorithmes métaheuristiques les plus avancés : évolutionnaires, essaims et bio-inspirés.", "metaheuristics|optimization|python|genetic-algorithm|swarm"},
	"https://github.com/flybirdxx/ComfyUI-Qwen-TTS":                      {"Nœud ComfyUI pour intégrer la synthèse vocale Qwen3-TTS dans des workflows de génération locaux.", "comfyui|tts|qwen|voice|local-ai|workflow"},
	"https://github.com/uezo/ChatdollKit":                                {"Framework Unity pour transformer un modèle 3D VRM en chatbot vocal interactif avec LLM et animations.", "unity|vrm|chatbot|tts|ai|voice|3d"},
	"https://ai4finance.org":                                             {"Framework de reinforcement learning financier open-source pour automatiser le trading sur actions, forex et crypto.", "reinforcement-learning|finance|trading|python|deep-learning"},
	"https://designmd.sh/":                                               {"Registre public de systèmes de design DESIGN.md installables en une commande pour les agents IA de coding.", "design-system|ai-agents|claude-code|registry|mcp"},
	"https://github.com/runablehq/mini-browser":                          {"Navigateur CLI first-for-agents pour intégrer la navigation web dans des workflows d'agents IA.", "browser|agents|cli|headless|ai-agents"},
	"https://colbymchenry.github.io/codegraph/":                          {"Graphe de connaissances de code pré-indexé pour Claude Code, Codex et Gemini réduisant tokens et appels d'outils.", "code-graph|knowledge|claude-code|codex|tokens|developer-tools"},
	"https://mercuryagent.sh/":                                           {"Agent IA soul-driven avec budgets de tokens, outils sécurisés et accès multicanal CLI/Telegram, actif 24h/7j.", "ai-agent|llm|cli|telegram|tools|self-hosted"},
	"https://github.com/huytieu/COG-second-brain":                        {"Second brain auto-évolutif avec 17 skills IA, 6 agents workers et CRM personnel inspiré de gstack/gbrain.", "second-brain|ai-agents|claude-code|obsidian|knowledge-management"},
	"https://github.com/grafana/skills":                                  {"Skills Claude Code officiels de Grafana pour l'observabilité, la création de dashboards et l'analyse de métriques.", "grafana|claude-code|skills|observability|monitoring"},
	"https://brightdata.com/":                                            {"Serveur MCP tout-en-un pour accéder au web public depuis des agents IA avec contournement anti-bot intégré.", "mcp|web-scraping|anti-bot|ai-agents|data-collection"},
	"https://github.com/ComposioHQ/awesome-codex-skills":                 {"Liste curatée de skills pratiques pour automatiser des workflows avec Codex CLI et API.", "codex|skills|awesome-list|automation|ai-agents"},
	"https://github.com/microsoft/fara":                                  {"Modèle Fara-7B de Microsoft efficient pour l'utilisation d'ordinateur (computer use) et l'automatisation.", "computer-use|ai|microsoft|agent|automation"},
	"https://open-design.ai/html-anything/":                              {"Éditeur HTML agentique avec 75 skills et 9 surfaces pour créer magazines, decks, posters et prototypes localement.", "html|agent|skills|claude-code|local-first|design"},
	"https://aka.ms/skillopt":                                            {"Optimiseur de skills textuels pour agents LLM figés via éditions guidées par trajectoires et validation.", "llm|skills|optimization|agents|microsoft|nlp"},
	"https://docs.kaelio.com/ktx":                                        {"Couche de contexte exécutable pour agents data et analytics via MCP avec mémoire sémantique et requêtes précises.", "mcp|data|analytics|agents|claude-code|semantic-layer"},
	"https://moonshotai.github.io/kimi-code/":                            {"Point de départ officiel pour les agents de nouvelle génération par Moonshot AI, créateurs du modèle Kimi.", "ai-agents|moonshot|kimi|framework|next-gen"},
	"https://skills.mercuryagent.sh":                                     {"Registre curé de skills réutilisables pour Mercury Agent, Open Claw et Hermes Agent optimisés pour la mémoire.", "agent-skills|mercury|registry|workflow|developer-tools"},
	"https://github.com/microsoft/Webwright":                             {"Framework d'agent navigateur de Microsoft atteignant SOTA sur les tâches web de longue durée.", "browser-agent|web|microsoft|automation|research"},
	"https://github.com/blader/humanizer":                                {"Skill Claude Code pour détecter et supprimer les signatures d'écriture IA générée dans un texte.", "claude-code|skill|ai-detection|writing|humanizer"},
	"https://github.com/jpeggdev/humanize-writing":                       {"Skill Claude Code pour réécrire du contenu généré par IA afin qu'il sonne naturellement humain.", "claude-code|skill|writing|humanizer|ai-detection"},
	"https://github.com/Aboudjem/humanizer-skill":                        {"Détecteur de 43 patterns d'écriture IA avec 5 voix, score de naturalité 0-100 et zéro dépendance.", "claude-code|skill|humanizer|ai-detection|writing|nlp"},
	"https://github.com/langgptai/awesome-claude-prompts":                {"Collection curatée de prompts pour utiliser Claude de manière plus efficace et créative.", "claude|prompts|awesome-list|anthropic|llm"},
	"https://github.com/travisvn/awesome-claude-skills":                  {"Liste curatée de skills, ressources et outils pour personnaliser les workflows Claude Code et Claude Desktop.", "claude-code|skills|awesome-list|anthropic|agent"},
	"https://github.com/ailabs-393/ai-labs-claude-skills":                {"Package unifiant des skills Claude pour simplifier leur installation dans n'importe quel projet.", "claude-code|skills|package|developer-tools|ai"},
	"https://theaioperator.io":                                           {"Skill cross-CLI pour Obsidian transformant votre vault en second cerveau IA-first avec 43 commandes et intégration Google Calendar.", "obsidian|claude-code|skill|second-brain|knowledge-management|ai"},
	"https://github.com/MadsLorentzen/ai-job-search":                     {"Framework Claude Code pour évaluer des offres d'emploi, adapter le CV et préparer les entretiens IA.", "claude-code|job-search|ai|cv|career|automation"},
	"https://www.skool.com/aiworkshop":                                   {"Équipe de vente IA pour Claude Code : prospection, qualification BANT/MEDDIC et rédaction de proposals.", "claude-code|skills|sales|ai-agents|crm|automation"},
	"https://github.com/mattpocock/skills":                               {"Skills Claude Code du TypeScript expert Matt Pocock pour les ingénieurs professionnels.", "claude-code|skills|typescript|developer-tools|expert"},
	"https://open-jarvis.github.io/OpenJarvis/":                          {"Assistant IA personnel open-source conçu pour fonctionner localement sur appareils personnels.", "ai-assistant|local-ai|personal|open-source|self-hosted"},
	"https://github.com/EpicStaff/EpicStaff":                             {"Plateforme open-source de construction d'agents IA avec interface visuelle et backend modulaire Python.", "ai-agents|workflow|visual|low-code|open-source|python"},
	"https://freephdlabor.github.io/":                                    {"Système multi-agents personnalisable pour automatiser la recherche scientifique en continu 24h/7j.", "ai-agents|research|multiagent|automation|science"},
	"https://suricata.io":                                                {"Moteur IDS/IPS et monitoring réseau open-source de l'OISF pour la détection d'intrusions en temps réel.", "ids|ips|network|threat-detection|open-source|security"},
	"https://flowsint.io":                                                {"Plateforme moderne d'investigations OSINT basée sur des graphes pour les analystes cybersécurité.", "osint|investigation|graph|security|recon"},
	"https://openosint.tech":                                             {"Agent OSINT IA avec REPL interactif, serveur MCP et 16 outils pour la recherche de sécurité autorisée.", "osint|ai-agent|mcp|cli|security|python"},
	"http://blog.ahmadz.ai/DeepZero/":                                    {"Framework automatisé de recherche de vulnérabilités 0-day analysant des milliers de drivers Windows avec agents IA.", "vulnerability-research|zero-day|ai-agents|reverse-engineering|windows|kernel"},
	"https://www.dolthub.com":                                            {"Base de données MySQL-compatible avec versioning Git intégré : branches, diffs, merge et clone de données.", "database|git|version-control|mysql|sql|data-versioning"},
	"https://tair-opensource.github.io/RedisShake/":                      {"Outil de migration et traitement de données Redis/Valkey avec synchronisation en temps réel entre clusters.", "redis|migration|valkey|data-processing|go"},
	"https://dbxio.com":                                                  {"Client de base de données multi-protocoles ultra-léger 15MB (MySQL, PostgreSQL, SQLite, Redis, MongoDB, DuckDB...).", "database|client|gui|multi-database|rust|tauri"},
	"https://github.com/Almamu/linux-wallpaperengine":                    {"Fonds d'écran animés Wallpaper Engine pour Linux via OpenGL, compatible avec les papiers achetés sur Steam.", "linux|wallpaper|opengl|desktop|animation|steam"},
	"https://github.com/zoicware/RemoveWindowsAI":                        {"Script PowerShell pour supprimer forcement Copilot, Recall et autres composants IA intrusifs de Windows 11.", "windows|debloat|copilot|privacy|powershell|ai"},
	"https://openlogi.org":                                               {"Alternative open-source à Logitech Options+ écrite en Rust pour remapper boutons, DPI et SmartShift sans compte ni télémétrie.", "logitech|mouse|rust|privacy|open-source|gpui"},
	"https://fluentflyout.com":                                           {"Application Windows 11 moderne de flyouts media avec widgets dans la barre des tâches selon Fluent 2 Design.", "windows|windows-11|flyout|media|taskbar|fluent-design"},
	"https://netwatchlabs.com":                                           {"Diagnostic système TUI mono-machine avec 12 onglets, insights en langage naturel et scrubber de session pour macOS et Linux.", "tui|system|monitoring|diagnostics|macos|linux"},
	"https://mattermost.com":                                             {"Plateforme de collaboration open-source sécurisée pour les équipes DevOps avec intégrations CI/CD et ChatOps.", "collaboration|messaging|devops|self-hosted|open-source"},
	"https://github.com/FreeU-group/FreeTodo":                            {"Gestionnaire de tâches IA qui auto-gère le contexte, l'historique et la priorité des tâches personnelles.", "todo|ai|task-management|context|productivity"},
	"https://uninbox.com":                                                {"Email moderne open-source pour équipes et professionnels, alternative self-hosted à Hey, Front et Missive.", "email|self-hosted|open-source|team|messaging"},
	"https://logseq.com":                                                 {"Plateforme PKM local-first open-source combinant notes Markdown, base de données et graphe de connaissances bidirectionnel.", "pkm|notes|knowledge-graph|local-first|markdown|open-source"},
	"https://whisper.money":                                              {"Gestionnaire de finances personnelles self-hosted open-source pour comprendre ses dépenses sans tableurs.", "finance|personal-finance|self-hosted|budget|open-source|privacy"},
	"https://quarkdown.com":                                              {"Markdown avec superpowers pour créer articles, présentations, sites, livres et bases de connaissances.", "markdown|typesetting|documentation|presentations|kotlin"},
	"https://typst.app":                                                  {"Système de composition typographique moderne basé sur balisage, puissant et facile à apprendre comme alternative à LaTeX.", "typesetting|latex|documents|pdf|markup|rust"},
	"https://transmute.sh":                                               {"Convertisseur de fichiers self-hosted supportant 2000+ formats : images, vidéo, audio, JSON, Excel et plus.", "file-converter|self-hosted|docker|fastapi|utilities"},
	"https://gyroflow.xyz":                                               {"Stabilisateur vidéo professionnel utilisant les données gyroscope de la caméra (GoPro, Insta360, Sony Alpha).", "video|stabilization|gyroscope|gopro|rust|gpu"},
	"https://github.com/HermannBjorgvin/Clawdmeter":                      {"Dashboard ESP32 de bureau affichant la consommation de tokens Claude Code en temps réel sur écran physique.", "esp32|claude-code|tokens|hardware|dashboard|embedded"},
	"https://github.com/ferrolho/VL53L5CX-BNO08X-viewer":                 {"Scanner 3D artisanal combinant capteur Time-of-Flight VL53L5CX et IMU BNO08X pour générer un nuage de points.", "tof|sensor|3d-scanner|hardware|electronics|embedded"},
	"https://deadmesh.boo":                                               {"Pont Internet-over-LoRa connectant les réseaux mesh Meshtastic à Internet via passerelle UDP.", "lora|mesh|meshtastic|networking|hardware|iot"},
	"https://github.com/mq1/TinyWiiBackupManager":                        {"Gestionnaire de sauvegardes Wii léger et open-source en Rust avec support WBFS et homebrew.", "wii|backup|rust|homebrew|gaming"},
	"https://github.com/bobeff/open-source-games":                        {"Liste curatée de jeux open-source multigenres incluant action, stratégie, RPG et simulation.", "games|open-source|awesome-list|gaming"},
	"https://github.com/MuxaJlbl4/Awesome-PlayStation-Vita":              {"Collection de ressources, homebrew, outils et émulateurs pour la PlayStation Vita.", "psvita|homebrew|gaming|awesome-list|sony"},
	"https://github.com/opengeos/qgis-gee-data-catalogs-plugin":          {"Plugin QGIS pour explorer et rechercher des données du Google Earth Engine Data Catalog et Community Catalog.", "qgis|earth-engine|geospatial|satellite|python"},
	"https://github.com/Walkator/Kailius":                                {"Jeu de plateforme 2D RPG PixelArt développé avec Unity pour Android, Windows et Linux.", "unity|game|rpg|pixel-art|android|2d"},
	"https://skydiscover-ai.github.io/":                                  {"Plateforme de découverte scientifique et algorithmique pilotée par des agents IA.", "ai|research|science|discovery|autonomous-agents"},
	"https://kitchenowl.org/":                                            {"Gestionnaire de courses et recettes self-hosted avec application Flutter multiplateforme et suivi des dépenses.", "grocery|recipes|self-hosted|flutter|food|mobile"},
	"https://www.echo-loop.top":                                          {"Application d'apprentissage de l'anglais par IA avec écoute aveugle, suivi et répétition espacée.", "language-learning|english|ai|spaced-repetition|flutter"},
	"https://bluecolo.red/bluemap":                                       {"Outil Minecraft créant des cartes 3D interactives de vos mondes affichées dans un navigateur web.", "minecraft|maps|3d|webgl|visualization|plugin"},
	"https://o3de.org":                                                   {"Moteur de jeu 3D open-source Apache 2.0 pour créer des jeux AAA, mondes cinema et simulations haute fidélité.", "game-engine|3d|open-source|apache|gamedev"},
	"https://tinyhumans.ai/openhuman":                                    {"Assistant IA personnel super-intelligent auto-hébergeable, privé et simple à utiliser.", "ai-assistant|local-ai|personal|open-source|privacy"},
	"https://fredy.orange-coding.net/":                                   {"Scraper d'annonces immobilières en Allemagne avec alertes instantanées via Slack, Telegram ou Email.", "real-estate|scraper|automation|nodejs|self-hosted"},
	"https://thomaschampagne.github.io/elevate-docs/":                    {"Application sportive open-source pour analyser et améliorer son entraînement via l'extension Strava.", "fitness|strava|sport|chrome-extension|analytics"},
	"https://ascendapi.com":                                              {"API de 11000+ exercices de fitness avec vidéos, GIFs, instructions étape par étape et ciblage musculaire.", "fitness|api|exercises|dataset|workout"},
	"https://github.com/gotify/android":                                  {"Application Android officielle pour recevoir les notifications push du serveur Gotify auto-hébergé.", "android|push-notifications|gotify|self-hosted|java"},
	"https://kami.tw93.fun":                                              {"Application de lecture minimaliste pour apprécier du bon contenu sous forme de papier élégant.", "reading|app|minimal|content|tauri"},
	"http://tmrts.com/go-patterns":                                       {"Liste curatée de patterns de conception, recettes et idiomes pour écrire du Go idiomatique et efficace.", "go|golang|design-patterns|learning|reference"},
	"https://github.com/mikeroyal/Windows-Terminal-Guide":                {"Guide exhaustif Windows Terminal : WSL, PowerShell, outils CLI, personnalisation et ressources.", "windows|terminal|wsl|powershell|guide|learning"},
	"https://github.com/devangshekhawat/Fedora-44-Post-Install-Guide":    {"Guide de post-installation Fedora 44 : codecs, drivers NVIDIA, optimisation batterie et tweaks GNOME.", "fedora|linux|post-install|gnome|nvidia|guide"},
	"https://pcottle.github.io/learnGitBranching/":                       {"Tutoriel Git interactif avec visualisation des branches et rebases pour maîtriser les commandes avancées.", "git|learning|interactive|tutorial|branches|visualization"},
	"https://github.com/byungsoo-oh/ml-systems-papers":                   {"Collection curatée d'articles de recherche sur les systèmes de machine learning.", "machine-learning|papers|research|awesome-list|systems"},
	"https://github.com/hahwul/MobileHackersWeapons":                     {"Collection d'outils utilisés par les hackers mobile pour Android et iOS en bug bounty.", "mobile|hacking|android|ios|bugbounty|awesome-list"},
	"https://github.com/darkoperator/mimikatz-missing-manual":            {"Manuel de référence complet pour Mimikatz, l'outil de credential dumping et d'attaque Windows.", "mimikatz|windows|credentials|pentesting|security|reference"},
	"https://github.com/bradtraversy/design-resources-for-developers":    {"Répertoire curé de 400+ ressources design et UI pour développeurs : photos, frameworks CSS, libs, outils.", "design|ui|resources|awesome-list|css|developers"},
	"https://github.com/sidpalas/devops-directive-github-actions-course": {"Dépôt du cours GitHub Actions Beginner to Pro de DevOps Directive avec exemples pratiques.", "github-actions|cicd|devops|learning|course"},
	"https://models.dev":                                                 {"Base de données open-source de modèles IA avec comparatifs, métadonnées et coûts.", "ai|models|database|comparison|llm|reference"},
	"https://github.com/imthenachoman/how-to-secure-a-linux-server":      {"Guide évolutif et détaillé de hardening d'un serveur Linux avec étapes concrètes et explications.", "linux|security|hardening|server|guide|ssh"},
	// Batch ajout juillet 2026
	"https://helix-editor.com":          {"Éditeur de texte modal post-moderne écrit en Rust, inspiré de Kakoune et Vim.", "editor|modal|rust|vim|kakoune"},
	"https://mui.com/x/":                {"Composants React avancés pour applications riches en données : Data Grid, sélecteurs de date/heure, graphiques.", "react|components|data-grid|charts|material-ui"},
	"https://xyflow.com":                {"Bibliothèques open-source pour créer des interfaces basées sur des nœuds (diagrammes, flowcharts) en React ou Svelte.", "react|svelte|node-based-ui|flowchart|diagram"},
	"https://penpot.app":                {"Plateforme de design et prototypage open-source pour équipes produit, alternative self-hostable à Figma.", "design|prototyping|ui-ux|open-source|collaboration"},
	"https://goravel.dev":               {"Framework de développement Go complet et modulaire, inspiré de Laravel (API, gRPC, microservices).", "golang|framework|laravel|api|grpc"},
	"https://github.com/bearstech/bbdb": {"Débogueur interactif pour scripts Bash, pas à pas avec inspection des variables.", "bash|shell|debugger|scripting|cli"},
	"https://docs.temporal.io":          {"Moteur d'orchestration de workflows durables pour microservices, avec exécution fiable et reprise sur erreur.", "workflow|orchestration|microservices|durable-execution|golang"},
	"http://rundeck.org":                {"Plateforme d'automatisation en self-service : donne accès à des scripts/outils existants sans exposer l'infrastructure sous-jacente.", "automation|runbook|devops|orchestration|self-service"},
	"https://docs.docker.com/compose/":  {"Exemples officiels Docker Compose prêts à l'emploi pour des dizaines de stacks applicatives.", "docker|docker-compose|samples|self-hosted|awesome-list"},
	"https://ministack.org":             {"Émulateur AWS local open-source : 55+ services, compatible Terraform, bases de données réelles. Alternative gratuite à LocalStack.", "aws|emulator|localstack-alternative|terraform|devtools"},
	"https://www.olares.com/":           {"OS cloud personnel open-source pour héberger des agents IA en continu, basé sur Kubernetes.", "personal-cloud|self-hosted|kubernetes|homelab|ai-agents"},
	"https://questdb.com":               {"Base de données time-series open-source haute performance pour l'analytique temps réel (finance, IoT).", "time-series|database|olap|sql|real-time-analytics"},
	"https://pgdog.dev":                 {"Pooler de connexions PostgreSQL avec load balancing et sharding de bases de données.", "postgresql|pooler|sharding|load-balancer"},
	"https://databasus.com":             {"Outil de sauvegarde PostgreSQL avec Point-In-Time-Recovery et vérification de restauration.", "postgresql|backup|pitr|devops|self-hosted"},
	"https://cactuscompute.com":         {"Moteur d'inférence IA on-device pour mobiles, wearables et robots (quantization, kernels, runtime).", "on-device-ai|edge-ai|inference|mobile|llm"},
	"https://www.amazon.science/publications/scrabblegan-semi-supervised-varying-length-handwritten-text-generation": {"ScrabbleGAN : génération semi-supervisée de texte manuscrit de longueur variable (recherche Amazon, CVPR20).", "gan|handwriting|ocr|research|amazon"},
	"https://tensorflow.org":                                    {"Framework open-source de machine learning pour l'entraînement et le déploiement de modèles.", "machine-learning|deep-learning|python|framework"},
	"https://aihub.qualcomm.com/models":                         {"Collection de modèles IA optimisés par Qualcomm pour le déploiement sur ses puces (latence, mémoire).", "qualcomm|inference|onnx|edge-ai|models"},
	"https://www.datalab.to":                                    {"OCR et analyse de mise en page (reconnaissance de tableaux, ordre de lecture) pour plus de 90 langues.", "ocr|document-ai|layout-analysis|datalab"},
	"https://mosi.cn/models/moss-tts":                           {"Famille de modèles open-source de synthèse vocale et génération audio haute fidélité, multi-locuteurs et temps réel.", "tts|text-to-speech|voice-cloning|audio|llm"},
	"https://arxiv.org/abs/2405.14831":                          {"Framework RAG inspiré de la mémoire humaine à long terme : graphes de connaissances + PageRank personnalisé (NeurIPS'24).", "rag|knowledge-graph|llm|research|nlp"},
	"https://www.genspark.ai/agents":                            {"Espace de travail IA tout-en-un : slides, docs, images, vidéo et code générés par agents.", "ai|workspace|agents|generative-ai|saas"},
	"https://ai-text-humanizer-app-by-dada.streamlit.app/":      {"Reformule du texte généré par IA en style plus humain pour contourner les détecteurs IA.", "ai|nlp|humanizer|streamlit|python"},
	"https://synapseorch.com":                                   {"Plateforme open-source pour créer et orchestrer des agents IA multi-LLM, avec support MCP et n8n.", "multi-agent|mcp|orchestration|llm-agent|n8n"},
	"https://mcp-toolbox.dev/documentation/introduction/":       {"Serveur MCP open-source pour connecter des agents IA à des bases de données (PostgreSQL, BigQuery, MongoDB...).", "mcp|mcp-server|database|agent|llm"},
	"https://copaper.ai":                                        {"Collection de 23 000+ skills d'agents IA pour la recherche empirique en sciences sociales, par CoPaper.AI.", "agent-skills|ai-agent|research|copaper"},
	"https://github.com/kaymen99/personal-ai-assistant":         {"Assistant IA personnel multi-agents connecté à WhatsApp, Slack ou Telegram pour gérer emails, agenda et tâches.", "ai-agent|assistant|langchain|langgraph|automation"},
	"https://mini-swe-agent.com":                                {"Agent IA minimaliste (100 lignes) qui résout des issues GitHub ou assiste en ligne de commande, plus de 74% sur SWE-bench.", "coding-agent|swe-bench|cli|ai-agent"},
	"https://gortex.dev/":                                       {"Moteur d'intelligence de code pour agents IA et IDE, basé sur un graphe de connaissances, réduit l'usage de tokens jusqu'à 50x.", "code-analysis|mcp-server|knowledge-graph|ai-agent|local-first"},
	"https://github.com/benmaster82/Kwipu":                      {"Moteur Graph RAG 100% local pour interroger ses notes Markdown/Obsidian via recherche hybride, sans cloud (Ollama).", "graph-rag|obsidian|mcp|ollama|local-first"},
	"https://codeflow-five.vercel.app":                          {"Génère une carte d'architecture interactive à partir de n'importe quelle URL GitHub, 100% dans le navigateur.", "architecture|visualization|github|d3js|codebase"},
	"https://understand-anything.com/":                          {"Transforme n'importe quel code en graphe de connaissances interactif à explorer et interroger, compatible Claude Code/Codex/Cursor.", "knowledge-graph|codebase-analysis|claude-code|visualization"},
	"https://jsoncrack.com/":                                    {"Transforme JSON, YAML, XML et CSV en graphes interactifs pour explorer visuellement des données structurées.", "json|yaml|visualization|graph|tool"},
	"https://www.svggobbler.com":                                {"Extension de navigateur open-source pour trouver, éditer, optimiser et exporter du contenu SVG.", "svg|browser-extension|optimization|design"},
	"https://open-design.ai/html-video":                         {"Génère des vidéos MP4 programmatiquement à partir de HTML/CSS pour les agents de code, avec moteurs de rendu et bande-son IA.", "video-generation|html-to-video|ffmpeg|ai-agent"},
	"https://www.jetify.com/devbox/":                            {"Crée des environnements de développement instantanés et reproductibles basés sur Nix, sans Docker.", "nix|dev-environment|reproducible|cli"},
	"https://pnpm.io":                                           {"Gestionnaire de paquets Node.js rapide et économe en espace disque, avec liens durs partagés entre projets.", "nodejs|package-manager|javascript|npm-alternative"},
	"https://chrisbuilds.github.io/terminaltexteffects/":        {"Moteur d'effets visuels pour terminal, utilisable en ligne de commande ou comme bibliothèque Python.", "terminal|ascii-art|python|cli"},
	"https://opentui.com":                                       {"Bibliothèque pour créer des interfaces utilisateur en mode terminal (TUI).", "tui|terminal|library|opencode"},
	"https://github.com/microsoft/terminal":                     {"Terminal moderne pour Windows avec onglets, thèmes et support WSL, plus la console originale Windows.", "windows|terminal|wsl|console|microsoft"},
	"https://trycap.dev":                                        {"Alternative open-source et self-hosted à reCAPTCHA basée sur preuve de travail, respectueuse de la vie privée.", "captcha|anti-bot|proof-of-work|self-hosted|privacy"},
	"https://spoofdpi.dev":                                      {"Outil anti-censure qui contourne l'inspection profonde de paquets (DPI) pour un accès réseau libre.", "anti-censorship|dpi|proxy|golang"},
	"https://clashmac.app":                                      {"Client proxy natif pour macOS basé sur Clash/Mihomo, avec interface SwiftUI.", "proxy|clash|macos|network|swiftui"},
	"https://pangolin.net":                                      {"VPN et reverse-proxy tunnelé à connaissance zéro pour l'accès distant, basé sur WireGuard.", "vpn|wireguard|reverse-proxy|zero-trust|self-hosted"},
	"https://databunker.org/":                                   {"Coffre-fort sécurisé pour données PII/PHI/PCI/KYC : anonymisation, tokenisation et conformité RGPD/CCPA.", "pii|vault|gdpr|encryption|compliance"},
	"https://github.com/elm1nst3r/GHOST-osint-crm":              {"Plateforme open-source de gestion d'investigations OSINT : suivi de personnes, connexions et renseignements.", "osint|investigation|crm|intelligence"},
	"https://www.adscanpro.com/docs":                            {"Outil gratuit de pentest Active Directory sous Linux : Kerberoasting, DCSync, relais NTLM, cartographie d'attaque type BloodHound.", "active-directory|pentest|red-team|kerberoasting|bloodhound"},
	"https://sightline-maps.vercel.app":                         {"Moteur de recherche OSINT pour cartographier des infrastructures réelles à partir des données OpenStreetMap.", "osint|openstreetmap|geoint|mapping"},
	"https://github.com/jonaslejon/malicious-pdf":               {"Génère des PDF malveillants de test pour évaluer callbacks, SSRF, XSS et vol NTLM dans lecteurs/convertisseurs PDF.", "pentest|pdf|ssrf|bugbounty|red-team"},
	"https://glfos.org/":                                        {"Distribution Linux basée sur NixOS, optimisée nativement pour le gaming (Steam, pilotes, outils prêts à l'emploi).", "linux|nixos|gaming|distribution|steam"},
	"https://monitorcontrol.app":                                {"Contrôle la luminosité et le volume des écrans externes sur Mac via les touches clavier natives.", "macos|monitor|brightness|volume|menubar"},
	"https://backintime.readthedocs.io":                         {"Interface graphique de sauvegarde incrémentale pour Linux, basée sur rsync avec liens durs pour économiser l'espace.", "backup|linux|rsync|gui|incremental"},
	"https://github.com/Raphire/Win11Debloat":                   {"Script PowerShell pour débloater Windows 10/11 : suppression d'apps préinstallées, désactivation de la télémétrie, personnalisation.", "windows|powershell|debloat|privacy|tweaks"},
	"https://dockdoor.net":                                      {"Améliore le dock macOS : aperçu des fenêtres, alt-tab amélioré et autres raccourcis.", "macos|window-management|productivity|dock"},
	"https://barutsrb.github.io/OmniWM/":                        {"Gestionnaire de fenêtres en tuiles pour macOS inspiré de Niri/Hyprland, signé et notarisé pour environnements d'entreprise.", "macos|tiling|window-manager|swift"},
	"https://www.chatwoot.com/help-center":                      {"Plateforme open-source de support client : live-chat, email, multi-canal, alternative à Intercom/Zendesk.", "customer-support|live-chat|self-hosted|helpdesk"},
	"https://tolaria.md":                                        {"Application desktop pour gérer des bases de connaissances Markdown.", "markdown|notes|knowledge-base|desktop"},
	"https://opencloud.eu":                                      {"Plateforme open-source de gestion, partage et collaboration de fichiers, alternative souveraine à Nextcloud.", "file-sharing|collaboration|self-hosted|open-source|cloud"},
	"https://playground.foliopdf.dev":                           {"Bibliothèque Go pour générer des PDF : mise en page, HTML-to-PDF, formulaires, signatures, PDF/A.", "pdf|go|html-to-pdf|library|pdf-generation"},
	"https://github.com/0x2E/fusion":                            {"Lecteur RSS self-hosted léger, simple à déployer et à utiliser.", "rss|feed-reader|self-hosted|lightweight"},
	"https://github.com/pixel-point/media-downloader":           {"Téléchargeur de vidéos natif pour macOS, avec édition/rognage intégré.", "macos|video|downloader|media"},
	"https://vidbee.org":                                        {"Télécharge des vidéos depuis presque n'importe quel site (YouTube, TikTok, Twitter, Facebook).", "downloader|video|youtube|tiktok"},
	"https://github.com/zostaff/ai-quant-researcher":            {"Agent IA pour la recherche quantitative en finance.", "ai|finance|quant|research"},
	"https://github.com/humanplane/terminal":                    {"Terminal de trading open-source et auto-hébergé pour Polymarket (marchés prédictifs).", "trading|polymarket|prediction-markets|self-custodial|rust"},
	"https://workout.cool":                                      {"Plateforme open-source de coaching fitness : plans d'entraînement, suivi de progression, base d'exercices.", "fitness|workout|coach|nextjs|open-source"},
	"https://github.com/rashevskyv/DBIPatcher":                  {"Traduit l'interface de DBI (installeur Nintendo Switch) vers d'autres langues.", "nintendo-switch|dbi|translation|homebrew"},
	"https://flame-engine.org":                                  {"Moteur de jeu 2D basé sur Flutter, pour créer des jeux multiplateformes en Dart.", "game-engine|flutter|dart|gamedev"},
	"https://github.com/ResearAI/AutoFigure-Edit":               {"Outil de recherche IA pour l'édition automatique de figures scientifiques.", "research|ai|figures"},
	"https://pokerogue.net":                                     {"Fangame Pokémon dans le navigateur, inspiré du genre roguelite.", "game|pokemon|roguelite|browser-game"},
	"https://beatsync.gg":                                       {"Lecteur web haute précision pour synchroniser l'audio sur plusieurs appareils (audio spatial).", "web-audio|synchronization|multi-device|spatial-audio"},
	"https://demo.liketrek.com":                                 {"Planificateur de voyage self-hosted avec collaboration temps réel, cartes interactives, budgets et listes de bagages.", "travel|self-hosted|collaborative|trip-planner"},
	"https://mentraglass.com":                                   {"OS pour lunettes connectées : sous-titres en direct, streaming de vue, IA conversationnelle, capture photo mains libres.", "smart-glasses|wearable|os|ai|hardware"},
	"https://www.theunwindai.com":                               {"Collection de 100+ agents et applications IA/RAG open-source, prêts à l'emploi.", "awesome-list|llm|agents|rag|python"},
	"https://www.inclusion-ai.org/insight":                      {"Panorama data-driven de l'écosystème agentic AI, produit par Ant Group et inclusionAI.", "agentic-ai|landscape|ecosystem|llm|research"},
	"https://git.io/macx":                                       {"Liste curatée de logiciels macOS de qualité, organisés par catégorie.", "awesome-list|macos|apps|software"},
	"https://bytebytego.com/guides":                             {"Explications visuelles de concepts de system design pour préparer les entretiens techniques.", "system-design|interview|architecture|learning"},
	"https://github.com/javabuddy/best-system-design-resources": {"Collection des meilleures ressources pour apprendre le system design et l'architecture logicielle.", "system-design|resources|architecture|learning"},
	"https://github.com/binhnguyennus/awesome-scalability":      {"Patterns et ressources pour concevoir des systèmes scalables, fiables et performants à grande échelle.", "awesome-list|scalability|architecture|system-design"},
	"https://ravencentric.cc/awesome-arr/":                      {"Liste curatée d'outils *arr (Sonarr, Radarr...) et ressources associées pour l'automatisation média.", "awesome-list|arr|media-automation|self-hosted"},
	"https://practice.course.rs":                                {"Apprendre Rust par la pratique : exercices progressifs entre niveau débutant et confirmé.", "rust|learning|exercises|awesome-list"},
	// Batch ajout juillet 2026 (2)
	"https://www.git-town.com":                                    {"Outil CLI pour simplifier les workflows Git : branches, rebases et synchronisation automatisés.", "git|cli|workflow|branches|productivity"},
	"https://wait4x.dev":                                          {"Attend qu'un port ou service (DB, HTTP, DNS...) soit prêt avant de continuer un script ou pipeline CI.", "cli|healthcheck|devops|ci|automation"},
	"https://frankenphp.dev":                                      {"Serveur d'application PHP moderne basé sur Caddy, avec support worker mode et early hints.", "php|server|caddy|go|performance"},
	"https://nvchad.com":                                          {"Distribution Neovim rapide et préconfigurée avec une belle UI par défaut.", "neovim|editor|lua|ide|dotfiles"},
	"https://react.fluentui.dev":                                  {"Composants React officiels de Microsoft pour construire des applications web selon le design Fluent.", "react|components|microsoft|ui|design-system"},
	"https://github.com/3b1b/manim":                               {"Moteur d'animation Python pour créer des vidéos pédagogiques de mathématiques, utilisé par 3Blue1Brown.", "animation|python|math|education|video"},
	"https://platform.ultralytics.com":                            {"YOLO : détection d'objets, segmentation et pose estimation en temps réel, framework de référence en vision par ordinateur.", "computer-vision|yolo|object-detection|deep-learning|pytorch"},
	"https://github.com/neuphonic/neutts":                         {"Modèle de synthèse vocale (TTS) fonctionnant entièrement on-device, sans cloud.", "tts|on-device|speech|ai"},
	"https://portkey.ai/features/ai-gateway":                      {"Passerelle IA unifiée routant vers 1600+ LLMs avec guardrails, cache et failover intégrés.", "llm|gateway|mcp|llmops|api"},
	"https://scalar.com":                                          {"Plateforme API open-source : client REST moderne, documentation OpenAPI/Swagger générée automatiquement.", "api|openapi|swagger|rest-client|documentation"},
	"https://pkgx.sh":                                             {"Exécute n'importe quel outil CLI à la demande sans installation permanente, gestionnaire d'environnements universel.", "package-manager|cli|environment|devtools"},
	"https://syncthing.net/":                                      {"Synchronisation de fichiers continue et décentralisée en pair-à-pair, alternative open-source à Dropbox.", "file-sync|p2p|self-hosted|open-source|backup"},
	"https://blockads.pwhs.app":                                   {"Bloque les publicités sur Android via filtrage DNS local par VPN, sans root ni collecte de données.", "android|adblock|dns|vpn|privacy"},
	"https://github.com/MetaCubeX/ClashMetaForAndroid":            {"Client Clash Meta pour Android : tunnel proxy basé sur des règles.", "proxy|clash|android|vpn|tunnel"},
	"https://github.com/Genymobile/scrcpy":                        {"Affiche et contrôle un appareil Android depuis le bureau, sans fil ou en USB, sans root.", "android|mirroring|remote-control|screen"},
	"https://iina.io":                                             {"Lecteur vidéo moderne et natif pour macOS, basé sur mpv.", "video-player|macos|mpv|media"},
	"https://docs.wizarr.dev":                                     {"Système de gestion des invitations utilisateurs pour Jellyfin, Plex et Emby.", "jellyfin|plex|emby|self-hosted|invitations"},
	"https://giantpinkrobots.github.io/varia/":                    {"Gestionnaire de téléchargements GTK4 : liens directs, torrents et vidéos (yt-dlp, aria2).", "download-manager|torrent|gtk4|linux|yt-dlp"},
	"https://github.com/stupside/castor":                          {"Diffuse n'importe quelle vidéo web vers Chromecast/DLNA en temps réel, transcodage et sous-titres inclus.", "chromecast|dlna|streaming|ffmpeg|casting"},
	"https://github.com/RROrg/rr":                                 {"Environnement de récupération/bootloader pour installer DSM Synology sur du matériel non officiel.", "synology|dsm|bootloader|nas|homelab"},
	"https://github.com/microsoft/AI-For-Beginners":               {"Cours gratuit de Microsoft : 24 leçons sur 12 semaines pour découvrir l'IA (vision, NLP, deep learning).", "ai|course|learning|deep-learning|microsoft"},
	"https://awesome-selfhosted.net/":                             {"Liste de référence des logiciels libres auto-hébergeables, par catégorie.", "awesome-list|self-hosted|open-source|free-software"},
	"https://awesome-android-root.pages.dev":                      {"Liste curatée des meilleures apps root, modules Magisk/KernelSU/LSPosed et guides de rootage Android.", "awesome-list|android|root|magisk|xposed"},
	"https://github.com/deepseek-ai/awesome-deepseek-integration": {"Liste curatée d'intégrations de l'API DeepSeek dans des outils populaires.", "awesome-list|deepseek|llm|api"},
	"https://gdevelop.io":                                         {"Moteur de jeu 2D/3D no-code open-source, création par événements sans programmation.", "game-engine|no-code|open-source|gamedev"},
}
