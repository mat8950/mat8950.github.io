#!/usr/bin/env python3
"""
enrich_meta.py — Injecte description + tags dans bookmarks.csv
...
CSV  = os.path.join(REPO, 'bookmarks.csv')
...
def main():
    ...
    print(f"[OK] {updated} descriptions ajoutées / {len(rows)} entrées totales")
